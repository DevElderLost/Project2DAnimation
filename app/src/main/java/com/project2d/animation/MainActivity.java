...
public class MainActivity extends AppCompatActivity {
    ...
    private void toggleTimeline(){
        ...
        int screenH=getScreenH();
        FrameLayout.LayoutParams lp=(FrameLayout.LayoutParams)timelineView.getLayoutParams();
        lp.topMargin=screenH-timelineH; timelineView.setLayoutParams(lp);
        float from=timelineVisible?timelineH:0f, to=timelineVisible?0f:(float)timelineH;
        timelineAnim=ValueAnimator.ofFloat(from,to);
    ...
    private void setupTimeline(){
        timelineView.setOnTimelineEvent(new TimelineView.OnTimelineEvent(){
            ...
            @Override public void onLayerAdded(){
                timelineView.invalidate();
            }
    ...
    private EditText buildET(String hint){
        ...
        et.setHintTextColor(ImGuiTheme.COLOR_TEXT_DISABLED); et.setTextColor(ImGuiTheme.COLOR_TEXT);
        et.setTextSize(12); et.setTypeface(Typeface.MONOSPACE); et.setInputType(InputType.TYPE_CLASS_NUMBER);
